    ...
    <section className="section-solid-alt">
      <div className="section-solid-content">
        ...
        >
          ...
          {source ? (
            <p className="mt-3 font-body text-xs text-cream/60 md:text-sm">
              {source}
            </p>
          ) : null}
        </motion.header>
        ...
        >
          {items.map((stat) => (
            ...
            >
              ...
              <p className="mt-3 max-w-[70ch] font-body text-base leading-[1.65] text-cream/85 md:text-lg">
                {stat.label}
              </p>
            </motion.div>
          ))}
        ...
        <motion.p
          ...
          className="title-backdrop-center mt-14 text-center font-display text-[clamp(1.125rem,2.8vw,1.5rem)] italic leading-snug text-cream md:mt-16"
        >
          {closing}
        </motion.p>
      </div>
