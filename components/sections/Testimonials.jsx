...
export default function Testimonials() {
  ...
  return (
    <motion.section
      ...
      className="section-solid relative w-full overflow-hidden"
    >
      <div
      ...
      <motion.div
        ...
        className="section-solid-content"
      >
        <div className="mx-auto max-w-2xl text-center">
          ...
          <motion.div
            variants={disableMotion ? staticFade : softFadeUp}
            className="relative mx-auto mt-8 md:mt-10"
          >
            <span
            ...
            <div className="relative rounded-sm border border-gold/15 bg-green-deep/40 px-6 py-8 backdrop-blur-[2px] md:px-10 md:py-9">
              <p className="text-pretty max-w-[70ch] font-body text-base leading-[1.65] text-cream/85 md:text-lg">
          ...
          <motion.div
            ...
            className="mt-8"
          >
            <p className="font-body text-base leading-[1.65] text-cream/80">
              {t.testimonials.hint}
            </p>
            <div className="mt-4">
