...
export const SEO = {
  fr: {
    ...
    privacyDescription:
      "Politique de confidentialité de Jamana Hub : collecte et traitement des renseignements personnels conformément à la Loi 25 (Québec).",
    legalTitle: "Mentions légales",
    legalDescription:
      "Mentions légales de Jamana Hub : éditeur du site, hébergement et conditions d'utilisation.",
  },
  en: {
    title:
    ...
    privacyDescription:
      "Jamana Hub privacy policy: collection and processing of personal information under Quebec’s Law 25 (Loi 25).",
    legalTitle: "Legal notice",
    legalDescription:
      "Jamana Hub legal notice: site publisher, hosting, and terms of use.",
  },
};
