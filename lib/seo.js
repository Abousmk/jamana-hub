...
export const SEO = {
  fr: {
    ...
    description:
      "Réseau de jeunes professionnels et entrepreneurs musulmans au Québec et à Montréal. Networking, entrepreneuriat et valeurs pour bâtir sans se renier.",
    mediaTitle: "Média",
    mediaDescription:
...
export function organizationJsonLd() {
  return {
    ...
    sameAs: [
      "https://www.instagram.com/jamana.hub/",
      "https://www.threads.net/@jamana.hub",
    ],
  };
}
